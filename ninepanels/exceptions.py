...
class OrchestratePanelResponseException(NinePanelsBaseException): ...


class OrchestratePanelUpdateException(NinePanelsBaseException): ...


class PadDaysException(NinePanelsBaseException): ...


class DayNotUpdated(NinePanelsBaseException): ...
